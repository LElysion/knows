	...
	render(){
		...
		return (
			<Form className="login-form login-formp">
				<sapn className="register-line">新用户注册</sapn>
				<FormItem>
				邮箱地址: <Input type="text"  prefix={<Icon type="mail" style={{ fontSize: 13 }} />}
				value={user.email} 
				...
				<FormItem>
				账号名称: <Input type="text" prefix={<Icon type="user" style={{ fontSize: 13 }} />}
				value={user.username} 
				...
				<FormItem>
				您的密码:<Input type="password" prefix={<Icon type="lock" style={{ fontSize: 13 }} />}
				value={user.password}  
				...
				<FormItem>
				重复密码: <Input type="password"  prefix={<Icon type="lock" style={{ fontSize: 13 }} />}
				...
				<FormItem>
				您的性别: <Input type="text" prefix={<Icon type="smile-o" style={{ fontSize: 13 }} />}
				value={user.gender}
				readOnly="true"
				...
				<FormItem>
				联系电话: <Input type="text"  prefix={<Icon type="mobile" style={{ fontSize: 13 }} />}
				value={user.mobile} 
				...
				<FormItem>
				真实姓名: <Input type="text"  prefix={<Icon type="user" style={{ fontSize: 13 }} />}
					value={user.realname} 
				...
				<FormItem>
				身份证号: <Input type="text"  prefix={<Icon type="user" style={{ fontSize: 13 }} />}
					value={user.idcard} 
